...
export function LoadingScreen({ progress, label }: LoadingScreenProps) {
  return (
    <div className="grid min-h-[480px] place-items-center rounded-3xl border border-slate-200 bg-white p-10 shadow-soft">
      <motion.div
      ...
      >
        ...
        <h3 className="text-3xl font-semibold text-slate-950">Building your course content</h3>
